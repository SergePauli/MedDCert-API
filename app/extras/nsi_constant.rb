...
module NsiConstant
  ...
  # разрешенные значения для пункта "на основании.."
  BASIS_DETERMINING = ["осмотра трупа", "записей в медицинской документации", "предшествующего наблюдения за пациентом", "вскрытия"].freeze
  # разрешенные значения для пункта "в случае смерти беременной.."
  PREGNANCY_CONNECTION = ["смерть беременной (независимо от срока и локализации)", "в процессе родов", "в течение 42 дней после окончания беременности", "в течение 43-365 дней после окончания беременности"].freeze
  # разрешенные значения для пункта "семейное положение.."
  MARITAL_STATUSES = {
    4 => "состоял(а) в зарегистрированном браке",
    5 => "не состоял(а) в зарегистрированном браке",
    3 => "неизвестно",
  }.freeze
  # разрешенные значения для пункта "образование.."
  EDUCATION_LEVELS = {
  ...
  # разрешенные значения для пункта "занятость.."
  SOCIAL_STATUSES = {
    4 => "студент(ка)",
    5 => "работал(а)",
  ...
  # разрешенные значения для пункта "доношенность.."
  TERM_PREGNANCY = ["доношенный (37-41 недели)", "недоношенный (менее 37 недель)",
                    "переношенный (42 недели и более)"]
end
